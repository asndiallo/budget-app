  ...
  const segments = [
    {
      ...
      pct: pct(invested),
      color: '#4a8cff',
      tip: 'TSP + investment fixed expenses',
    },
    {
      label: 'Committed',
      value: committed,
      pct: pct(committed),
      color: '#f5aa2a',
      tip: 'Fixed recurring bills + debt payments',
    },
    {
      label: 'Spending',
      value: spending,
      pct: pct(spending),
      color: '#ff4560',
      tip: 'Discretionary transactions this month',
    },
    {
      label: 'Net',
      ...
      color: '#00d98a',
      tip: 'Remaining unallocated income',
    },
  ];
  ...
  return (
    <div className="bg-surface border-border rounded-xl border px-4 py-3.5">
      <div className="mb-2.5 flex items-center justify-between">
        <p className={LABEL_CLS}>Income allocation</p>
      ...
      <div className="mt-2.5 flex flex-wrap gap-4">
        {segments.map(({ label, pct: p, color, value, tip }) => (
          <Tooltip key={label} content={`${formatCurrency(value)} — ${tip}`} side="bottom">
